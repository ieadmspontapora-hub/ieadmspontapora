    ...
    <>
      <section className="py-16 md:py-20 bg-transparent">
        <div className="container mx-auto px-4">
          ...
          <Card className="overflow-hidden rounded-3xl border border-black/10 bg-[#FFD700] shadow-[0_25px_50px_rgba(0,0,0,0.15)]">
              ...
              <div className="flex flex-col lg:grid lg:grid-cols-2">
                ...
                <div className="order-2 lg:order-1 flex flex-col justify-center p-6 sm:p-8 md:p-12 text-center lg:text-left">
                  ...
                  <Button
                    ...
                    className="bg-blue-900 hover:bg-blue-800 text-white font-semibold rounded-xl px-10 py-6 text-base shadow-lg transition-all duration-300 hover:scale-[1.05] active:scale-[0.97] w-full sm:w-auto"
                  >
                    {buttonText}
                  </Button>
                </div>
      ...
      {/* MODAL PIX */}
      <PixModal isOpen={openPix} onClose={() => setOpenPix(false)} />
    </>
  );
}
